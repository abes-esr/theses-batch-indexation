...
import fr.abes.theses_batch_indexation.utils.VedetteProcessor;
...
public class TheseMappee {
    ...
    public TheseMappee(Mets mets, List<Set> oaiSets, int idDoc) {
        try {
            ...
            try {
                VedetteProcessor vedetteProcessor = new VedetteProcessor(dmdSec, sujetsRameauPpn, sujetsRameauLibelle, sujetsRameau);
